...
[LeftThigh, LeftThighGapArray] = Markers3D.readDataVicon(filename,VisualEyezRun,...
            'LeftThighRB','LeftThighLB','LeftThighFT','doFilter',true);
